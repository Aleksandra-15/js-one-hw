/* const elemLastChildNextSibling = null;
console.log(elemLastChildNextSibling);  

const elemchildren = [0];
...
image.addEventListener("click", () => {
  image.src = "https://promocodiuscdn.com/assets/ukr/images/goiteens.png";
});
